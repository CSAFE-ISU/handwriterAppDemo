...
demoPreviewServer <- function(id, global) {
  shiny::moduleServer(
    ...
    function(input, output, session) {
      demoImageServer("demo1", global, file.path("data", "model_docs", "w0009_s01_pWOZ_r01.png"))
      demoImageServer("demo2", global, file.path("data", "model_docs", "w0009_s01_pWOZ_r02.png"))
      demoImageServer("demo3", global, file.path("data", "model_docs", "w0009_s01_pWOZ_r03.png"))
      demoImageServer("demo4", global, file.path("data", "model_docs", "w0030_s01_pWOZ_r01.png"))
      demoImageServer("demo5", global, file.path("data", "model_docs", "w0030_s01_pWOZ_r02.png"))
      demoImageServer("demo6", global, file.path("data", "model_docs", "w0030_s01_pWOZ_r03.png"))
      demoImageServer("demo7", global, file.path("data", "model_docs", "w0203_s01_pWOZ_r01.png"))
      demoImageServer("demo8", global, file.path("data", "model_docs", "w0203_s01_pWOZ_r02.png"))
      demoImageServer("demo9", global, file.path("data", "model_docs", "w0203_s01_pWOZ_r03.png"))
      demoImageServer("demo10", global, file.path("data", "model_docs", "w0238_s01_pWOZ_r01.png"))
      demoImageServer("demo11", global, file.path("data", "model_docs", "w0238_s01_pWOZ_r02.png"))
      demoImageServer("demo12", global, file.path("data", "model_docs", "w0238_s01_pWOZ_r03.png"))
      demoImageServer("demo13", global, file.path("data", "model_docs", "w0400_s01_pWOZ_r01.png"))
      demoImageServer("demo14", global, file.path("data", "model_docs", "w0400_s01_pWOZ_r02.png"))
      demoImageServer("demo15", global, file.path("data", "model_docs", "w0400_s01_pWOZ_r03.png"))
      
      demoImageServer("demoQ1", global, file.path("data", "questioned_docs", "w0009_s03_pLND_r02.png"))
      demoImageServer("demoQ2", global, file.path("data", "questioned_docs", "w0030_s02_pLND_r01.png"))
      demoImageServer("demoQ3", global, file.path("data", "questioned_docs", "w0238_s01_pLND_r01.png"))
    }
  )
}
